...
namespace PDFViewerSDK_Win10.view
{
    public class PDFView
    {
        ...
        protected ScrollViewer m_scroller = new ScrollViewer() { IsZoomInertiaEnabled = false };
        ...
        public interface PDFViewListener
        {
            ...
            /// <summary>
            /// fired when the zooming action starts.
            /// </summary>
            void OnPDFZoomStart();
            /// <summary>
            /// fired when the zooming action stops.
            /// </summary>
            void OnPDFZoomStop();
            /// <summary>
            /// fired whenever the PDF view moves.
            /// </summary>
            void OnPDFMoved();
        };
        /// <summary>
